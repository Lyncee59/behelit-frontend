...
const NODE_API_PUBLIC = process.env.NODE_API_PUBLIC || "http://localhost:8000" // "http://api-portfolio.behelit.uk"
const NODE_API_INTERNAL = process.env.NODE_API_INTERNAL || "http://localhost:8000" // "http://api-portfolio.behelit.uk"
